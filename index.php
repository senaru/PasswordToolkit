...
<body>
    <!-- TAB CONTROLLERS -->
    <input id="managePanel-ctrl" class="panel-radios" type="radio" name="tab-radios" checked>
    <input id="breachPanel-ctrl" class="panel-radios" type="radio" name="tab-radios">
    <input id="strengthPanel-ctrl" class="panel-radios" type="radio" name="tab-radios">
    <input id="generatorPanel-ctrl" class="panel-radios" type="radio" name="tab-radios">
    <input id="aboutPanel-ctrl" class="panel-radios" type="radio" name="tab-radios">
  ...
  <h2 id="email_value"> </h2>
    ...
    <ul id="tabs-list">
        ...
        <li id="li-for-managePanel">
            <label class="panel-label" for="managePanel-ctrl">Manage Passwords</label>
        </li>
        <!--INLINE-BLOCK FIX
 -->
        <li id="li-for-breachPanel">
            <label class="panel-label" for="breachPanel-ctrl">Password Breach</label>
        </li>
        <!--INLINE-BLOCK FIX
 -->
        <li id="li-for-strengthPanel">
            <label class="panel-label" for="strengthPanel-ctrl">AI Password Strength</label>
        </li>
        <!--INLINE-BLOCK FIX
 -->
        <li id="li-for-generatorPanel">
            <label class="panel-label" for="generatorPanel-ctrl">Password Generator</label>
        </li>
        <!--INLINE-BLOCK FIX
 -->
        <li id="li-for-aboutPanel" class="last">
            <label class="panel-label" for="aboutPanel-ctrl">About</label>
        </li>
                            ...
                            <div class="row alert">
                                <div class="col">
                                    <div id="alert-copy" class="alert-copy">
                                        <p>
                                            <i class="fa fa-copy"></i> Copied to Clipboard
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        //"Datatables Live Records Add Edit Delete using PHP Ajax JQuery", YouTube, 2017. [Online]. Available: https://www.youtube.com/watch?v=Xhl6UC3nsnE. [Accessed: 20- Oct- 2019].
